...
map({ 'n', 'v', 'x' }, 'gh', '0', { desc = 'Go to start of line' })
map({ 'n', 'v', 'x' }, 'gl', '$', { desc = 'Go to end of line' })
map({ 'n', 'v', 'x' }, 'gc', function() require('ada0l.utils').goto_window('center') end, { desc = 'Go to center of window' })
map({ 'n', 'v', 'x' }, 'gt', function() require('ada0l.utils').goto_window('top') end, { desc = 'Go to top of window' })
map({ 'n', 'v', 'x' }, 'gb', function() require('ada0l.utils').goto_window('bottom') end, { desc = 'Go to bottom of window' })
